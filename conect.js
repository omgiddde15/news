( () => {
            ...
            !function(a, o) {
                ...
                n = function() {
                    ...
                    function g(n) {
                        ...
                        typeof console !== s && ("trace" === n && r ? i : void 0 !== console[n] ? o(console, n) : void 0 !== console.log ? o(console, "log") : e)
                    }
                    function l() {
                    ...
                    function A(e, r) {
                                ...
                                if (typeof e === s)
                                    try {
                                        var r = window.document.cookie
                                          ...
                                          , t = r.indexOf(n + "=");
                                        -1 !== t && (e = /^([^;]+)/.exec(r.slice(t + n.length + 1))[1])
                                    } catch (e) {}
                                return void 0 === m.levels[e] && (e = void 0),
                                e
                            }
                        }
                        function f() {
                        ...
                        function p(e) {
                            var s = e;
                            if ("string" == typeof s && void 0 !== m.levels[s.toUpperCase()] && (s = m.levels[s.toUpperCase()]),
                    ...
                    (a = new A).getLogger = function(e) {
                        ...
                        var s = t[e];
                        return s || (s = t[e] = new A(e,a.methodFactory)),
                        s
                    }
                    ;
                    var d = typeof window !== s ? window.log : void 0;
                    return a.noConflict = function() {
                        return typeof window !== s && window.log === a && (window.log = d),
                        a
                    }
                    ,
                ...
                ,
                void 0 === (t = "function" == typeof n ? n.call(s, r, s, e) : n) || (e.exports = t)
            }()
        }
    }
      , s = {};
    ...
    r.d = (e, s) => {
        for (var n in s)
            r.o(s, n) && !r.o(e, n) && Object.defineProperty(e, n, {
                enumerable: !0,
                get: s[n]
            })
    }
    ...
    ( () => {
        ...
        function o(e, s=0) {
            return a[e[s + 0]] + a[e[s + 1]] + a[e[s + 2]] + a[e[s + 3]] + "-" + a[e[s + 4]] + a[e[s + 5]] + "-" + a[e[s + 6]] + a[e[s + 7]] + "-" + a[e[s + 8]] + a[e[s + 9]] + "-" + a[e[s + 10]] + a[e[s + 11]] + a[e[s + 12]] + a[e[s + 13]] + a[e[s + 14]] + a[e[s + 15]]
        }
        ...
        class c {
            ...
            constructor(e, s) {
                ...
                window.addEventListener("message", (s => {
                    if (s.data.namespace !== this.NAMESPACE)
                        return;
                    const {type: r} = s.data;
                    "response" === r ? this.handleResponse(s.data) : "message" === r && s.data.target === e && this.handleMessage(s.data)
                }
                ))
            }
            onAll(e) {
            ...
            async handleMessage(e) {
                ...
                if ("function" == typeof this.globalListener) {
                    const s = await Promise.resolve(this.globalListener(e.name, e.data, r));
        ...
        class A {
            ...
            findCallbackIndex(e) {
                let s = null;
                return this.listeners.forEach(( (r, n) => {
                    r === e && (s = n)
                }
                )),
                s
            ...
            assign(e) {
                ...
                case "addListener":
                    return e => {
                        ...
                        this.registerEvents && this.message.send(this.messageTarget, "chrome: add runtime message listener")
                    }
                    ;
                case "removeListener":
                    return e => {
        ...
        class d {
            ...
            findCallbackIndex(e, s) {
                let r = null;
                return this.listeners[e]?.forEach(( (e, n) => {
                    e === s && (r = n)
                }
                )),
                r
            ...
            assign(e, s) {
                ...
                case "addListener":
                    ...
                    s => {
                        ...
                        this.registerEvents && this.message.send(this.messageTarget, "chrome: add listener", {
                            event: e
                        })
                    }
                    ;
                ...
                case "hasListeners":
                    return () => void 0 !== this.listeners[e] && (this.listeners[e]?.length ?? 0) > 0;
                default:
                    return () => {}
                }
            }
        ...
        class u {
            ...
            assign(e) {
                return (...s) => {
                    ...
                    r ? this.message.send(this.messageTarget, "chrome: call method", n).then(r) : this.message.send(this.messageTarget, "chrome: call method", n)
                }
            }
        }
        const f = ["addListener", "removeListener", "hasListener", "hasListeners", "dispatch", "dispatchToListener"];
        let p, h;
        function b(e, s, r="") {
            let n, t;
        ...
        (async () => {
            const e = "webcrx";
            if (document.documentElement.hasAttribute(e))
                return;
            document.documentElement.toggleAttribute(e);
            const s = new c("sandbox",window)
              , r = await s.send("content/bridge", "main: get sandbox content script", {
